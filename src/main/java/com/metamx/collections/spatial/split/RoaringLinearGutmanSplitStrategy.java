...
/**
 */
public class RoaringLinearGutmanSplitStrategy extends RoaringGutmanSplitStrategy
{
  public RoaringLinearGutmanSplitStrategy(int minNumChildren, int maxNumChildren)
  {
   ...
   */
  public RoaringNode[] pickSeeds(List<RoaringNode> nodes)
  {
    ...
    return new RoaringNode[]{nodes.remove(indexToRemove1), nodes.remove(indexToRemove2 - 1)};
  }
  ...
  public RoaringNode pickNext(List<RoaringNode> nodes, RoaringNode[] groups)
  {
