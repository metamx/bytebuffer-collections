...
/**
 */
public class RoaringImmutableRTreeTest
{
  @Test
  ...
  public void showBenchmarks()
  {
    ...
    for (int numPoints = start; numPoints <= end; numPoints *= factor) {
      try {
        ...
        Iterable<ImmutableRoaringBitmap> points = searchTree.search(new RoaringRadiusBound(new float[]{50, 50}, radius));
